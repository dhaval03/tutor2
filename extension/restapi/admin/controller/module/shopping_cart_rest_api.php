...
class ShoppingCartRestApi extends \Opencart\System\Engine\Controller {
    ...
    public function index() {
        $this->load->language('extension/restapi/module/shopping_cart_rest_api');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/restapi/module/shopping_cart_rest_api', 'user_token=' . $this->session->data['user_token'], true)
        );
        ...
        $data['action']     = $this->url->link('extension/restapi/module/shopping_cart_rest_api', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/restapi/module/shopping_cart_rest_api', $data));
    ...
    protected function validate() {
        ...
        if (!$this->user->hasPermission('modify', 'extension/restapi/module/shopping_cart_rest_api')) {
            $hasError = true;
        }
