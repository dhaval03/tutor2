...
class Purpletreesellerfeatured extends \Opencart\System\Engine\Controller {
		private $error = array();
		
		public function index() {
			$this->load->language('extension/purpletree_multivendor/module/purpletree_sellerfeatured');
			...
			if (!isset($this->request->get['module_id'])) {
				...
				'href' => $this->url->link('extension/purpletree_multivendor/module/purpletree_sellerfeatured', 'user_token=' . $this->session->data['user_token'], true)
				);
				} else {
				$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/purpletree_multivendor/module/purpletree_sellerfeatured', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true)
				);
			}
			
			$data['action'] = $this->url->link('extension/purpletree_multivendor/module/purpletree_sellerfeatured', 'user_token=' . $this->session->data['user_token'], true);
		...
		if (isset($this->request->post['module_purpletree_sellerfeatured_height'])) {
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/module/purpletree_sellerfeatured', $data));
		}
		protected function validate() {
			if (!$this->user->hasPermission('modify', 'extension/purpletree_multivendor/module/purpletree_sellerfeatured')) {
