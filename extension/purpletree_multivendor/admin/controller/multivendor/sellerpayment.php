...
class Sellerpayment extends \Opencart\System\Engine\Controller {
		...
		public function index(){
			...
			if (!$validateSeller) {
				...
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/stores', 'user_token=' . $this->session->data['user_token'], true));
			}
		...
		'href' => $this->url->link('extension/purpletree_multivendor/multivendor/sellerpayment', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/sellerpayment', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
		]);
