...
class Managesubscriptionplan extends \Opencart\System\Engine\Controller {
		private $error = array();		
		...
		$validateSeller = $this->load->controller('extension/purpletree_multivendor/multivendor/config');
			...
			$this->load->language('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
			$this->document->setTitle($this->language->get('heading_title'));
			$this->load->model('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
			$this->getList();			
		}
		...
		public function add():void {
			...
			if (!$validateSeller) {
				$this->load->language('extension/purpletree_multivendor/multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan', 'user_token=' . $this->session->data['user_token'] . $url, true));
			}
		...
		$invoice_status=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getInvoiceStatusfromSeller($seller_id);
		...
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|add', 'user_token=' . $this->session->data['user_token'].'&seller_id='.$this->request->get['seller_id'] , true));
		}
		}
		$total_seller_assign_product = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getTotalSellerPorduct($seller_id);
		$getnewplanProducts = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getnewplanProducts($plan_id);
		...
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|plan_confirm', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $seller_id .'&plan_id='.$plan_id.'&start_date='.$start_date.'&status='.$status.'&existing='.$existing.'&action='.$this->request->get['action'], true));
		} else {
		...
		$this->session->data['plan_id'] 	= $plan_id;
		$this->session->data['start_date']  = $start_date;
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|plan_confirm', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $seller_id .'&plan_id='.$plan_id.'&start_date='.$start_date.'&status='.$status.'&existing='.$existing, true));
		} else {
		$this->error['error_select_plan']= $this->language->get('error_please_select_seller');
		}
		} 
		...
		$this->load->model('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		if($id && $seller_id){
		$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->active($id);
		}
		$this->load->language('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		$this->session->data['success'] = $this->language->get('text_plan_activated');
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan/viewallplan', 'user_token=' . $this->session->data['user_token'].'&seller_id='.$seller_id, true));
		...
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view', 'user_token=' . $this->session->data['user_token'], true));
		} 
		...
		$current_plan=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getPlanBySeller($seller_id);
		$result=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSubscribePlan($plan_id);
		if($startt_when == 1) {
		
		$current_plan_start_date=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentPlanByPlanId($seller_id,$plan_id);
		...
		$data['end_date']='';
		$old_invoice_id=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getInvoiceId($seller_id);			
		
		$currentplan=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentPlan($seller_id);
		...
		$current_invoice=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerCurrentPlan($seller_id);
		...
		$customer = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCustomer($seller_id);
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
		$invoice_id=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->addMultipleSellerPlan($data);				
		$sellerExist=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->SellerExist($seller_id);
		$email_subject= $this->language->get('email_subject');
		if(!$sellerExist){
		$sellerExist=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->addFirstSellerPlan($seller_id);	
		$email_subject = $this->language->get('email_first_subject');
		}
		
		//if plan free or grand total less then zero
		if($total<=0){
		$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->enableSellerSubscription($seller_id);
		}
		//end
		...
		// Mail 		
			...
			$this->load->model('extension/purpletree_multivendor/multivendor/mails');	
				...
				$mail_subject_vars=array(
						...
						$emailTemplate=$this->model_extension_purpletree_multivendor_multivendor_mails->getEmailTemplate('admin_to_seller_subscription_plan_mail_by_admin');
						...
						$this->model_extension_purpletree_multivendor_multivendor_mails->sendMail($customer['email'],$subject,$message);	
		//end mail
		...
		$this->load->language('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		$this->load->language('extension/purpletree_multivendor/multivendor/subcriptionplan');
		$this->load->model('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		$invoice_status=$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getInvoiceStatuss($seller_id);
		...
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view', '', true));
		}
		} 
		...
		$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|addNewPlan', 'user_token=' . $this->session->data['user_token'] . '&seller_id=' . $this->request->get['seller_id'] . $url, true);
		...
		$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/plan_confirm', $data));
		}
		...
		$this->load->language('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		$this->load->model('extension/purpletree_multivendor/multivendor/managesubscriptionplan');
		$subscribed = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSubscriptionplan($this->request->get['seller_id']);
		...
		$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->changeSubscription($this->request->post['subscription_status'],$seller_id);
		if(isset($this->request->post['subscription_disable']))
		{
		$this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->changeStatus($this->request->post['subscription_disable'],$seller_id);		
		}
		...
		$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|add', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $seller_id .'&action=add', true);
		...
		$total_featured_product = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->sellerTotalFeaturedProduct($seller_id);
		
		$total_category_featured_product = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->sellerTotalCategpryFeaturedProduct($seller_id);
		...
		$used_products=0;
		if($this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getsellerProducts($seller_id)){
		$used_products = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getsellerProducts($seller_id);
		}
		...
		if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$current_plan=array();
		$current_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentMultiplePlan($seller_id);
		$current_plan_detail = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentSellerMultiplePlan($seller_id);
		}  else {
		$current_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentPlan1($seller_id);
		$current_plan_detail = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentSellerPlan($seller_id);
		...
		$invoice_status = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->invoice_status($current_value['seller_id'],$current_value['plan_id']);
		...
		'validity'=>$current_value['validity'],
		'view_plan'  => $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $current_value['seller_id'].'&plan_id='.$current_value['plan_id'], true),
		'edit_plan'  => $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|edit', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $current_value['seller_id'].'&plan_id='.$current_value['plan_id'].'&action=edit&status='.$status, true),
		'active_plan'  => $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|active', 'user_token=' . $this->session->data['user_token'] .'&id='. $current_value['id'].'&seller_id='. $current_value['seller_id'], true),
		...
		$data['subscription_status'] = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSubscriptionStatus($seller_id);
		$filter_data = array(
		'seller_id'  => $seller_id,
		...
		if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerMultiplePlansList($filter_data);
		} else {
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerPlansList($filter_data); 
		}
		
		$data['subscriptions'] = array();
		if(!empty($results)){
		foreach ($results as $result) { 
		$invoice_status = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getInvoiceStatus($result['invoice_id'] );
		...
		*/
		...
		'add_history'  => $this->url->link('extension/purpletree_multivendor/multivendor/subscriptionplaninvoice|add', 'user_token=' . $this->session->data['user_token'] .'&invoice_id='. $result['invoice_id'] .'', true),
		'view_invoice'  => $this->url->link('extension/purpletree_multivendor/multivendor/subscriptionplaninvoice|view', 'user_token=' . $this->session->data['user_token'] .'&invoice_id='. $result['invoice_id'] .'', true)
		);	
		}  
		}
		...
		// $pagination->url = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view', 'user_token=' . $this->session->data['user_token'] .'&seller_id=' . $this->request->get['seller_id']. $url . '&page={page}', true);
		
		// $data['pagination'] = $pagination->render();
		
		// $data['results'] = sprintf($this->language->get('text_pagination'), ($resultsTotal) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($resultsTotal - $this->config->get('config_limit_admin'))) ? $resultsTotal : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $resultsTotal, ceil($resultsTotal / $this->config->get('config_limit_admin'))); 
		$data['heading_title'] = $this->language->get('heading_title');
		...
		$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/subscriptionplan_all', $data));
		}
		...
		$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|add', 'user_token=' . $this->session->data['user_token'] .'&seller_id='. $seller_id .'', true);
		...
		$data['current_plan'] = array();
		//$current_plan=array();
		$current_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentPlan($seller_id);
		/* if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$current_plan=array();
		$current_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCurrentMultiplePlan($seller_id);
		} 
		...
		if(!empty($current_plan)) {
		$current_plan['used_products'] = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getsellerProducts($seller_id);
		...
		$results=array();
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerInvoiceList($filter_data);
		$resultsTotal = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getTotalSellerPlansList($filter_data);
		if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$results=array();
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerInvoiceList2($filter_data);
		$resultsTotal = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerInvoiceList2pagin($filter_data);
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}')
		]);
			
			$data['results'] = sprintf($this->language->get('text_pagination'), ($resultsTotal) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($resultsTotal - $this->config->get('config_pagination_admin'))) ? $resultsTotal : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $resultsTotal, ceil($resultsTotal / $this->config->get('config_pagination_admin')));
		$data['heading_title'] = $this->language->get('heading_title');
		$data['text_list_Seller_Plan_View'] = $this->language->get('text_list_Seller_Plan_View');
		$data['update_subscription_status'] = $this->language->get('update_subscription_status');
		$data['column_Enabled'] = $this->language->get('column_Enabled');
		...
		$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/subsacriptionplan_view', $data));
		}
		...
		$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$resultsTotal = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getManageSubscriptionPlanTotal($filter_data);
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getManageSubscriptionPlan($filter_data);
		//echo"<pre>";print_r($results);die;
		if(!empty($results)){
		foreach ($results as $result) {
		$subscribed = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSubscriptionplan($result['seller_id']);
		$customerStauts = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getCustomerStatus($result['seller_id']);
		if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$no_of_active_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getNoOfActiveMultiplePlan($result['seller_id']);
		if(!$no_of_active_plan){
		$no_of_active_plan=0;	
		}
		} else {
		$no_of_active_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getNoOfActivePlan($result['seller_id']);
		if(!$no_of_active_plan){
		$no_of_active_plan=0;	
		}
		}
		...
		'view'        		=> $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|viewallplan', 'user_token=' . $this->session->data['user_token'] . '&seller_id=' . $result['seller_id'] . $url, true)
		);
		} 
		}
		...
		$data['sort_name'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/vendor', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}')
		]);
		...
		$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/manage_subscription_plan_list', $data));
		}
		
		protected function getForm() {
		
		if (!isset($this->request->get['seller_id']) || $this->request->get['seller_id'] =='') {
		$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|viewallplan', 'user_token=' . $this->session->data['user_token'], true));
		}
		...
		$filter_datap1 = array(
			...
			$plan_results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getPlanName($filter_datap1);
		...
		$current_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getPlanById($seller_id,$plan_id) ;
		
		$active_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getActivePlan($seller_id,$plan_id) ;
		
		if($this->config->get('module_purpletree_multivendor_multiple_subscription_plan_active')){
		$active_plan = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getMultipleActivePlan($seller_id,$plan_id) ;
		}
		...
		$data['seller_name'] = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getSellerName($seller_id);
		//die;
        ...
        $data['cancel'] = $this->url->link('extension/purpletree_multivendor/multivendor/managesubscriptionplan|view','user_token=' . $this->session->data['user_token'] . '&seller_id=' . $this->request->get['seller_id'] . $url, true);
		...
		$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/manage_subscription_plan_form', $data));
		}
		...
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getStoreName($filter_data);
		...
		$results = $this->model_extension_purpletree_multivendor_multivendor_managesubscriptionplan->getPlanName($filter_data);
		if(!empty($results)){
		foreach ($results as $result) {
		$json[] = array(
		'plan_id' => $result['plan_id'],
