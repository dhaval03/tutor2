...
class Bulkshippingupload extends \Opencart\System\Engine\Controller {
		...
		public function upload(){
			...
			if (!$validateSeller) {
				...
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/bulkshippingupload', 'user_token=' . $this->session->data['user_token'] . $url, true));
			}
		...
		public function getData(){	
			...
			'href' => $this->url->link('extension/purpletree_multivendor/multivendor/bulkshippingupload', 'user_token=' . $this->session->data['user_token'] . $url, true)
			);		
			...
			$data['export'] = $this->url->link('extension/purpletree_multivendor/multivendor/bulkshippingupload|export', 'user_token=' . $this->session->data['user_token'], true);	
			
			$data['upload'] = $this->url->link('extension/purpletree_multivendor/multivendor/bulkshippingupload|upload', 'user_token=' . $this->session->data['user_token'], true);	
