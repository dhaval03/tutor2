...
class Sellerblogcomment extends \Opencart\System\Engine\Controller {
		private $error = array();		
		public function index() {
			...
			$this->load->language('extension/purpletree_multivendor/multivendor/sellerblogcomment');
			
			$this->document->setTitle($this->language->get('heading_title'));
			
			$this->load->model('extension/purpletree_multivendor/multivendor/sellerblogpost');
			$this->load->model('extension/purpletree_multivendor/multivendor/sellerblogcomment');
		...
		public function add() {
			...
			if (!$validateSeller) {
				$this->load->language('extension/purpletree_multivendor/multivendor/ptsmultivendor');
				$this->session->data['error_warning'] = $this->language->get('error_license');
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment', 'user_token=' . $this->session->data['user_token'] . $url, true));
			}
			$this->load->language('extension/purpletree_multivendor/multivendor/sellerblogcomment');
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->addComment($this->request->post);
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				$this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->editComment($this->request->get['comment_id'], $this->request->post);
		...
		public function delete() {
			...
			if (isset($this->request->post['selected']) && $this->validateDelete()) {
				foreach ($this->request->post['selected'] as $comment_id) {
					$this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->deleteComment($comment_id);
				}
		...
		protected function getList() {
			...
			'href' => $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment', 'user_token=' . $this->session->data['user_token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment|add', 'user_token=' . $this->session->data['user_token'] . $url, true);
			$data['delete'] = $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment|delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$comment_total = $this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->getTotalComments($filter_data);
			
			$results = $this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->getComments($filter_data);
			...
			foreach ($results as $result) {
				...
				'edit'       => $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment|edit', 'user_token=' . $this->session->data['user_token'] . '&comment_id=' . $result['blog_comment_id'] . $url, true)
				);
			}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
		]);
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/sellerblogcomment_list', $data));
		}
		...
		protected function getForm() {
			...
			if (!isset($this->request->get['comment_id'])) {
				$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment|add', 'user_token=' . $this->session->data['user_token'] . $url, true);
				} else {
				$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment|edit', 'user_token=' . $this->session->data['user_token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('extension/purpletree_multivendor/multivendor/sellerblogcomment', 'user_token=' . $this->session->data['user_token'] . $url, true);
			
			if (isset($this->request->get['comment_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
				$comment_info = $this->model_extension_purpletree_multivendor_multivendor_sellerblogcomment->getComment($this->request->get['comment_id']);
			}
			...
			$sellerBlogs = array();
			$sellerBlogs = $this->model_extension_purpletree_multivendor_multivendor_sellerblogpost->getBlogs($filter_data);
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/sellerblogcomment_form', $data));
		}
		
		protected function validateForm() {
			if (!$this->user->hasPermission('modify', 'extension/purpletree_multivendor/multivendor/sellerblogcomment')) {
