		      ...
		      if (!$this->customer->validateSeller($livecheck)) {
				...
				$this->response->redirect($this->url->link('customer/customer', 'user_token=' . $this->session->data['user_token'] . $url, true));
			     ...
			     $store_name = trim($this->request->post['seller_storename']);
							...
							$file ='';
							$this->model_extension_purpletree_multivendor_multivendor_vendor->addSeller($customer_id,$store_name, $this->request->post['become_seller'],$file);
		      ...
		      if (!$this->customer->validateSeller($livecheck)) {
				...
				$this->response->redirect($this->url->link('customer/customer', 'user_token=' . $this->session->data['user_token'] . $url, true));
				  ...
				  if(isset($this->request->post['seller_storename'])){
					...
					$this->load->model('extension/purpletree_multivendor/multivendor/vendor');
							$file ='';
							$this->model_extension_purpletree_multivendor_multivendor_vendor->editSeller($customer_id,$store_name, $this->request->post['become_seller'],$file);
...
$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('customer/customer', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
		]);
...
if (isset($this->error['seller_store'])) {
		...
		if (isset($this->request->get['customer_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$seller_info = $this->model_extension_purpletree_multivendor_multivendor_stores->getStoreDetail($this->request->get['customer_id']);
	...
	protected function validateForm() {
		 ...
		 if(isset($this->request->post['seller_storename'])){
		  if(isset($this->request->post['become_seller']) && ($this->request->post['become_seller'] == 1)){
			if ((strlen($this->request->post['seller_storename']) < 5) || (strlen(trim($this->request->post['seller_storename'])) > 50)) {
			$this->error['seller_store'] = $this->language->get('error_storename');
		}
		}
		}
				     $this->load->model('extension/purpletree_multivendor/multivendor/stores');				
            $store_info1 = $this->model_extension_purpletree_multivendor_multivendor_stores->getStoreNameByStoreName($this->request->post['seller_storename']);
		...
		if ((strlen($this->request->post['firstname']) < 1) || (strlen(trim($this->request->post['firstname'])) > 32)) {
			$this->error['firstname'] = $this->language->get('error_firstname');
		}

		if ((strlen($this->request->post['lastname']) < 1) || (strlen(trim($this->request->post['lastname'])) > 32)) {
	...
	public function history() {
		$this->load->language('extension/purpletree_multivendor/customer/customer');
...
$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('customer/customer/history', 'user_token=' . $this->session->data['user_token'] . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true)
		]);
...
$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('customer/customer/transaction', 'user_token=' . $this->session->data['user_token'] . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true)
		]);
		$data['results'] = sprintf($this->language->get('text_pagination'), ($transaction_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($transaction_total - $this->config->get('config_pagination_admin'))) ? $transaction_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $transaction_total, ceil($transaction_total / $this->config->get('config_pagination_admin')));
	...
	public function reward() {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('customer/customer/reward', 'user_token=' . $this->session->data['user_token'] . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true)
		]);
		$data['results'] = sprintf($this->language->get('text_pagination'), ($reward_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($reward_total - $this->config->get('config_pagination_admin'))) ? $reward_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $reward_total, ceil($reward_total / $this->config->get('config_pagination_admin')));
	...
	$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('customer/customer/ip', 'user_token=' . $this->session->data['user_token'] . '&customer_id=' . $this->request->get['customer_id'] . '&page={page}', true)
		]);
		$data['results'] = sprintf($this->language->get('text_pagination'), ($ip_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($ip_total - $this->config->get('config_pagination_admin'))) ? $ip_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $ip_total, ceil($ip_total / $this->config->get('config_pagination_admin')));
