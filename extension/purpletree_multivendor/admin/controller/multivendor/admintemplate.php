...
class Admintemplate extends \Opencart\System\Engine\Controller {
		private $error = array();
		...
		public function add() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->request->post['master_id'] = '';
				$this->request->post['quantity'] = 0;
				
				if(!empty($this->request->post['product_option'])) {
					foreach($this->request->post['product_option'] as $key => $product_option) {
						if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
							foreach($product_option['product_option_value'] as $key1 =>$product_option_value) {
								$this->request->post['product_option'][$key]['product_option_value'][$key1]['price'] = 0;			
								$this->request->post['product_option'][$key]['product_option_value'][$key1]['quantity'] = 0;			
								$this->request->post['product_option'][$key]['product_option_value'][$key1]['subtract'] = 0;			
								$this->request->post['product_option'][$key]['product_option_value'][$key1]['price_prefix'] = 0;			
								$this->request->post['product_option'][$key]['product_option_value'][$key1]['price_prefix'] = 0;
							}
						}
					}
			...
			$this->model_extension_purpletree_multivendor_multivendor_vendor->addAdmintemp($product_id,$this->request->post);
			...
			$temp_status = $this->model_extension_purpletree_multivendor_multivendor_vendor->checkTempstatus($this->request->get['product_id']);
			$status1 = '';			
			if($temp_status == 1){
			    $status1 = $this->request->post['status'];
				}else{
			...
			$this->model_extension_purpletree_multivendor_multivendor_vendor->deleteAdmintempProduct($product_id);
			...
			'href' => $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url, true)
			);
			
			$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|add', 'user_token=' . $this->session->data['user_token'] . $url, true);
			$data['delete'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$product_total = $this->model_extension_purpletree_multivendor_multivendor_vendor->getTotalAdmintempProduct($filter_data);
			
			$results = $this->model_extension_purpletree_multivendor_multivendor_vendor->geAdmintempProduct($filter_data);
			...
			'edit'       => $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $result['product_id'] . $url, true),
			'editdetail'       => $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|editTemplateDetail', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $result['product_id'] . '&template_id=' . $result['template_id'] . $url, true)
			...
			$data['sort_name'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
			$data['sort_model'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, true);
			$data['sort_status'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, true);
			$data['sort_order'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
		]);
			...
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/admintemplate_list', $data));
			}
			...
			$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|edit', 'user_token=' . $this->session->data['user_token'] . '&product_id=' . $this->request->get['product_id'] . $url, true);
			}
			
			$data['cancel'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$product_info = $this->model_extension_purpletree_multivendor_multivendor_vendor->getTemplateDetail($this->request->get['template_id']);
			$product_seller = $this->model_extension_purpletree_multivendor_multivendor_vendor->getProductSeller($this->request->get['template_id']);
			...
			$data['action'] = $this->url->link('extension/purpletree_multivendor/multivendor/admintemplate|editTemplateDetail', 'user_token=' . $this->session->data['user_token'] . '&template_id=' . $this->request->get['template_id'] . $url, true);
			}
			$data['stock_statuses'] = $this->model_localisation_stock_status->getStockStatuses();
			
			if(isset($this->request->get['template_id'])){	
			$data['template_id'] = $this->model_extension_purpletree_multivendor_multivendor_vendor->getTemplateId($this->request->get['template_id']);
			} 
				$data['product_id']='';
			if(isset($this->request->get['product_id'])){
			...
			$data['column_left'] = $this->load->controller('common/column_left');
			$data['footer'] = $this->load->controller('common/footer');
			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/admintemplatedetail_form',$data));
			}
			...
			$this->model_extension_purpletree_multivendor_multivendor_vendor->editDetail($this->request->get['template_id'], $this->request->post);
			
			$minprice = $this->model_extension_purpletree_multivendor_multivendor_vendor->getMinPrice( $this->request->post['product_id']);
			$tproduct_id= $this->model_extension_purpletree_multivendor_multivendor_vendor->getProductid($this->request->get['template_id']);
			...
			$template_num_rows = $this->model_extension_purpletree_multivendor_multivendor_vendor->getTemplateData($this->request->get['template_id'], $this->request->post['seller_id_filter']);
			...
			$this->load->model('design/seo_url');		
			$seo_url['filter_keyword'] = $keyword;
			$seo_urls = $this->model_design_seo_url->getSeoUrls($seo_url);

			foreach ($seo_urls as $seo_url) {
			if (($seo_url['store_id'] == $store_id) && (!isset($this->request->get['product_id']) || (($seo_url['key'] != 'product_id') && ($seo_url['value'] != $this->request->get['product_id'])))) {
