...
class PurpletreeSellerfeatured extends \Opencart\System\Engine\Controller {
		public function index() {
			...
			$this->load->model('extension/purpletree_multivendor/module/sellerfeatured');
			
			
			$productss = $this->model_extension_purpletree_multivendor_module_sellerfeatured->getFeatured();
			...
			if ($data['products']) {
			return $this->load->view('extension/purpletree_multivendor/module/purpletree_sellerfeatured', $data);
			} else {
			return '';
		}
		}
