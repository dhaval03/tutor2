		...
		public function index() { 
			if($this->config->get('module_purpletree_multivendor_status') && $this->config->get('module_purpletree_sellerdetail_status')){			
				...
				{					
					...
					if(isset($this->request->get['product_id'])){
					$seller_detail = $this->model_extension_purpletree_multivendor_multivendor_sellerproduct->getSellername($this->request->get['product_id']);
					}
					$seller_prices = array();
					...
					$store_detail = $this->model_extension_purpletree_multivendor_multivendor_vendor->getStore($seller_store_id);
					$seller_info_social = $this->model_extension_purpletree_multivendor_multivendor_vendor->getStoreSocial($seller_store_id);
				...
				return $this->load->view('extension/purpletree_multivendor/module/purpletree_sellerdetail', $data);			
