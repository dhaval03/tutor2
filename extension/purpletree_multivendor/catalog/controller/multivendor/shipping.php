...
class Shipping extends \Opencart\System\Engine\Controller {
		...
		public function index() {
			...
			if (!$this->customer->isLogged()) {
				$this->session->data['redirect'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping','language=' . $this->config->get('config_language'), true);
		...
		public function add() {
			...
			if(!$this->ptsValidateSeller) {
				...
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/shipping','language=' . $this->config->get('config_language'), true));
			}
			
			if (($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()) ) {
				$seller_id=$this->customer->getId();
				$this->model_extension_purpletree_multivendor_multivendor_shipping->addShipping($this->request->post,$seller_id);
				$this->session->data['success'] = $this->language->get('text_success_add');
				
				$url = '';
				
				$this->response->redirect($this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . $url.'&language=' . $this->config->get('config_language'), true));
			}
		...
		public function edit() {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST' && $this->validateForm()) ) {
				$seller_id=$this->customer->getId();
				$this->model_extension_purpletree_multivendor_multivendor_shipping->editShipping($seller_id,$this->request->get['shipping_id'],$this->request->post);
		...
		protected function getList() {
			...
			'href' => $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . $url.'&language=' . $this->config->get('config_language'), true)
			);
			
			$data['add'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping|add', '' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['delete'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping|delete', '' . $url.'&language=' . $this->config->get('config_language'), true);
			...
			foreach ($results as $result) {
				...
				'deletes'           => $this->url->link('extension/purpletree_multivendor/multivendor/shipping|deletes', '' . 'shipping_id=' . $result['id'] . $url.'&language=' . $this->config->get('config_language'), true),
				'edit'           => $this->url->link('extension/purpletree_multivendor/multivendor/shipping|edit', '' . 'shipping_id=' . $result['id'] . $url.'&language=' . $this->config->get('config_language'), true)
				);
			}
			...
			$data['sort_shipping_country'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=cu.name' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_zip_from'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=pvs.zipcode_from' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_zip_to'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=pvs.zipcode_to' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_price'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=pvs.shipping_price' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_weight_from'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=pvs.weight_from' . $url.'&language=' . $this->config->get('config_language'), true);
			$data['sort_weight_to'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . 'sort=pvs.weight_to' . $url.'&language=' . $this->config->get('config_language'), true);
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . $url . '&page={page}'.'&language=' . $this->config->get('config_language'), true)
		]);
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($shipping_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($shipping_total - $this->config->get('config_pagination_admin'))) ? $shipping_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $shipping_total, ceil($shipping_total / $this->config->get('config_pagination_admin')));
			...
			$data['sort'] = $sort;
			$data['order'] = $order;
			$data['url'] = $this->url->link('extension/purpletree_multivendor/multivendor/bulkshippingupload','language=' . $this->config->get('config_language'), true);	
		...
		protected function getForm() {
			...
			$data['cancel'] = $this->url->link('extension/purpletree_multivendor/multivendor/shipping', '' . $url.'&language=' . $this->config->get('config_language'), true);
		...
		protected function validateForm() {
			...
			/*         if( ! filter_var($this->request->post['max_days'], FILTER_VALIDATE_INT)   && $this->request->post['max_days'] != '0' ){
				...
				if(strlen($this->request->post['max_days'])  < 1){
