...
class FileManager extends \Opencart\System\Engine\Controller{
		public function index() { 
			$this->load->language('extension/purpletree_multivendor/common/filemanager');
			...
			foreach ($images as $image) {
				...
				if (is_dir($image)) {
					...
					'href'  => $this->url->link('extension/purpletree_multivendor/multivendor/common/filemanager', 'directory=' . urlencode(substr($image, strlen(DIR_IMAGE . 'catalog/'))) . $url.'&language=' . $this->config->get('config_language'), true)
					);
					...
					'type'  => 'image',
					'path'  => substr($image, strlen(DIR_IMAGE)),
					'href'  => 'image/' . substr($image, strlen(DIR_IMAGE))
					);
				}
			}
			...
			$data['parent'] = $this->url->link('extension/purpletree_multivendor/multivendor/common/filemanager', $url.'&language=' . $this->config->get('config_language'), true);
			...
			$data['refresh'] = $this->url->link('extension/purpletree_multivendor/multivendor/common/filemanager',$url.'&language=' . $this->config->get('config_language'), true);
			...
			$pagination->limit = 16;
			$pagination->url = $this->url->link('extension/purpletree_multivendor/multivendor/common/filemanager', $url . '&page={page}'.'&language=' . $this->config->get('config_language'), true);
			...
			'page'  => $page,
			'limit' => 16,
			'url'   => $this->url->link('extension/purpletree_multivendor/multivendor/common/filemanager', $url . '&page={page}'.'&language=' . $this->config->get('config_language'), true)
		]);

			$this->response->setOutput($this->load->view('extension/purpletree_multivendor/multivendor/common/pts_filemanager', $data));
		}
